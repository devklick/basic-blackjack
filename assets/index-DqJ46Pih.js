...
const CardWrapper = "_CardWrapper_yr2oj_1";
const Card$1 = "_Card_yr2oj_1";
const CardHighlight = "_CardHighlight_yr2oj_20";
const CardDim = "_CardDim_yr2oj_26";
const CardContent = "_CardContent_yr2oj_30";
const styles$9 = {
  CardWrapper,
  Card: Card$1,
  CardHighlight,
...
function Card({ rank, suit, facing, effect }) {
  ...
  const cardClasses = [
    styles$9.Card,
    effect === "dim" && styles$9.CardDim,
    effect === "highlight" && styles$9.CardHighlight
  ].join(" ");
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$9.CardWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cardClasses, style: { backgroundColor: color }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$9.CardContent, children: content }) }) });
}
...
const generateDeck = (deckType, shuffle = true) => {
  if (deckType !== "Standard") {
    throw new Error(`DeckType ${deckType} not yet supported.`);
  }
  const deckIndexes = [...Array(52).keys()];
  const deck = [];
  Object.values(CardRanks).forEach((rank) => {
    Object.values(CardSuits).forEach((suit) => {
      const card = { rank, suit, facing: "Up" };
      const positionInDeck = shuffle ? deckIndexes[randomIntInRange(0, deckIndexes.length - 1)] : deck.length;
...
const calculateBestHand = (cards) => {
  ...
  cards.forEach((card) => {
    ...
    const cardGlobalValue = Math.max(...CardRankMetadataMap[card.rank].relativeValues);
    bestHand.cards.push({
      card,
...
const determineWinner = (playerHand, dealerHand) => {
  ...
  const cardCountWinner = getCardCountWinner(playerHand.cards, dealerHand.cards);
  if (cardCountWinner) {
...
const getHighCardWinner = (playerCards, dealerCards) => {
...
const getScoreWinner = (playerScore, dealerScore) => {
...
const getCardCountWinner = (playerCards, dealerCards) => {
  const winner = getPlayerWithHighestValue(playerCards.length, dealerCards.length);
  if (!winner) return null;
  return {
    winner,
...
const getPlayerWithHighestValue = (playerValue, dealerValue) => {
  if (playerValue > dealerValue) return "Player";
  if (dealerValue > playerValue) return "Dealer";
  return null;
};
const cardDealt = "" + new URL("CardDealt-C13KGL2F.mp3", import.meta.url).href;
const roundLost = "" + new URL("RoundLost-BkD_4KT4.mp3", import.meta.url).href;
const roundWon = "" + new URL("RoundWon-CP05jIHT.mp3", import.meta.url).href;
const warning = "" + new URL("WarningAlert-3W1xfH_v.mp3", import.meta.url).href;
...
const nonPersistedKeys = ["settingsModalOpen"];
...
const defaultBestHand = { cards: [], score: 0 };
function useCardPile() {
  const [cards, setCardsState] = reactExports.useState([]);
  const bestHand = reactExports.useRef(defaultBestHand);
  const bust = reactExports.useRef(false);
  const fiveCardTrick = reactExports.useRef(false);
  const allCardsVisible = reactExports.useRef(false);
  const { play } = useAudioPlayer();
  function addCards(cardsToAdd, facing = null) {
  ...
  function setCards(cardsToSet) {
    ...
    fiveCardTrick.current = cardsToSet.length === 5 && bestHand.current.score <= 21;
    setCardsState(cardsToSet);
  }
  function setCardsFacing(facing) {
    setCards(
      [...cards].map((c) => {
        c.facing = facing;
        return c;
...
function useDeck({ deckType } = { deckType: "Standard" }) {
  const deck = reactExports.useRef(generateDeck(deckType));
  function take(count = 1, facing = "Up") {
...
const CardRow$1 = "_CardRow_i6yx7_1";
const CardOwner = "_CardOwner_i6yx7_6";
const Cards = "_Cards_i6yx7_19";
const styles$8 = {
  CardRow: CardRow$1,
  CardOwner,
  Cards
};
function CardRow({ cardOwner, cards, effect, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.CardRow, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.CardOwner, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.Cards, children: cards.map(({ facing, rank, suit }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { facing, rank, suit, effect }, i)) })
  ] });
}
const TableContainer = "_TableContainer_152hs_1";
const ScoreTable = "_ScoreTable_152hs_9";
const styles$7 = {
  TableContainer,
  ScoreTable
};
function CurrentHandScores({ scoreBoardRows }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: styles$7.ScoreTable, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Participant" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Score" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: scoreBoardRows.map((row, i) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.participant }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.displayScore ? row.score : "?" })
      ] }, i);
    }) })
  ] });
}
function TotalWins({ scoreBoardRows }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: styles$7.ScoreTable, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Wins" }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: scoreBoardRows.map((row, i) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.totalWins }) }, i);
    }) })
  ] });
}
function ScoreBoard({ scoreBoardRows }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.TableContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CurrentHandScores, { scoreBoardRows }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TotalWins, { scoreBoardRows })
  ] });
}
const ButtonContainer$1 = "_ButtonContainer_10m5m_1";
const styles$6 = {
  ButtonContainer: ButtonContainer$1
};
function PrePlayButtons({ onDealClicked }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onDealClicked(), children: "Deal" }, "start");
}
function InPlayButtons({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onHitClicked(), children: "Hit" }, "hit"),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onStickClicked(), children: "Stick" }, "stick")
  ] });
}
function Buttons({
  gameState,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.ButtonContainer, children: [
    prePlay && /* @__PURE__ */ jsxRuntimeExports.jsx(PrePlayButtons, { onDealClicked }),
    inPlay && /* @__PURE__ */ jsxRuntimeExports.jsx(InPlayButtons, { onHitClicked, onStickClicked })
  ] });
}
const InfoHud$1 = "_InfoHud_lmse1_1";
const Outcome = "_Outcome_lmse1_12";
const styles$5 = {
  InfoHud: InfoHud$1,
  Outcome
};
function InfoHud({ gameState, scoreBoardRows, outcome, clickHandlers }) {
  const displayScoreBoard = gameState !== "WaitingForStart";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.InfoHud, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.Outcome, children: outcome }),
    displayScoreBoard && /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreBoard, { scoreBoardRows }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Buttons, { gameState, clickHandlers })
  ] });
}
...
const YesNoPopUp$1 = "_YesNoPopUp_1jymd_1";
const Content$1 = "_Content_1jymd_11";
const ButtonContainer = "_ButtonContainer_1jymd_20";
const Yes = "_Yes_1jymd_1";
const No = "_No_1jymd_32";
const styles$4 = {
  YesNoPopUp: YesNoPopUp$1,
  Content: Content$1,
  ButtonContainer,
  Yes,
  No
...
function YesNoPopUp({
  ...
  const [disableFuture, setDisableFuture] = reactExports.useState(false);
  function onClick(ignore) {
    if (disableFuture) setWarningEnabled(type, false);
    if (ignore) onClickYes();
    else onClickNo();
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.YesNoPopUp, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.Content, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.ButtonContainer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$4.Yes, onClick: () => onClick(true), children: "Yes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$4.No, onClick: () => onClick(false), children: "No" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Don't warn me again" }),
...
const Table$1 = "_Table_19rs4_1";
const styles$3 = {
  Table: Table$1
};
const SettingsButton$1 = "_SettingsButton_11ls1_1";
const Open = "_Open_11ls1_13";
const Closed = "_Closed_11ls1_18";
const styles$2 = {
  SettingsButton: SettingsButton$1,
  Open,
  Closed
};
function SettingsButton({}) {
  ...
  const classes = [styles$2.SettingsButton, settingsModalOpen ? styles$2.Open : styles$2.Closed].join(
    " "
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes, onClick, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.Symbol, children: "☰" }) });
}
function Table({ hide = false }) {
  const game = useGame();
  const { play } = useAudioPlayer();
  const { hitWarningsEnabled, stickWarningsEnabled } = useGameSettingsStore();
  const [showHitWarning, setShowHitWarning] = reactExports.useState(false);
  const [showStickWarning, setShowStickWarning] = reactExports.useState(false);
  const onDealClicked = () => {
    if (game.state !== "WaitingForStart" && game.state !== "GameOver") return;
    game.setup();
  };
  const onHitClicked = (overrideWarning = false) => {
    if (game.state !== "PlayerRound") return;
    if (hitWarningsEnabled && game.getParticipantScore("Player") >= 18 && !overrideWarning) {
      play("warning");
  ...
  const onStickClicked = (overrideWarning = false) => {
    if (game.state !== "PlayerRound") return;
    if (stickWarningsEnabled && game.getParticipantScore("Player") <= 10 && !overrideWarning) {
      play("warning");
  ...
  function getCardEffect(cardOwner) {
    if (game.winner === "none") return "none";
    return cardOwner === game.winner ? "highlight" : "dim";
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.Table, style: { display: hide ? "none" : "" }, children: [
    showHitWarning && getHitWarning(),
    showStickWarning && getStickWarning(),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardRow, { cardOwner: "Dealer", cards: game.dealer.cards, effect: getCardEffect("Dealer"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsButton, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardRow, { cardOwner: "Player", cards: game.player.cards, effect: getCardEffect("Player") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      InfoHud,
      {
...
function useGame() {
  const [state, setState] = reactExports.useState("WaitingForStart");
  const [outcome, setOutcome] = reactExports.useState(null);
  const [winner, setWinner] = reactExports.useState("none");
  const deck = useDeck();
  ...
  reactExports.useEffect(() => {
    ...
    if (dealer.bust) {
      ...
      timeout = setTimeout(() => dealCardsToParticipant("Dealer", 1), delayBetweenActions);
    }
    return () => {
      clearTimeout(timeout);
    };
  ...
  reactExports.useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      const facing = cardCountBefore === 0 ? "Up" : "Down";
  ...
  function dealCardsToParticipant(participant, count = 1) {
  ...
  function setResult(outcomeText, winner2) {
    return setTimeout(() => {
      setState("GameOver");
      setOutcome(outcomeText);
      setWinner(winner2 ?? "none");
      if (winner2) {
        play(winner2 === "Player" ? "roundWon" : "roundLost");
      }
      winner2 && stats.updateWinnerStats(winner2);
    }, delayBetweenActions);
  }
  return {
    /**
...
const CheckBox$1 = "_CheckBox_13kd2_1";
const Checked = "_Checked_13kd2_13";
const Unchecked = "_Unchecked_13kd2_18";
const styles$1 = {
  CheckBox: CheckBox$1,
  Checked,
  Unchecked
...
function CheckBox({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: [className, styles$1.CheckBox, checked ? styles$1.Checked : styles$1.Unchecked].join(
        " "
      ),
      onClick: () => onChanged(!checked),
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: getSymbol() })
    }
  );
}
const GameSettings$1 = "_GameSettings_jeq7l_1";
const Title = "_Title_jeq7l_8";
const Content = "_Content_jeq7l_22";
const GameSetting = "_GameSetting_jeq7l_1";
const Info = "_Info_jeq7l_34";
const Header = "_Header_jeq7l_38";
const Description = "_Description_jeq7l_41";
const ControlWrapper = "_ControlWrapper_jeq7l_44";
const Control = "_Control_jeq7l_44";
const styles = {
...
function GameSettings() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.GameSettings, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.Content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.GameSetting, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.Info, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.Header, children: "Clear Saved Wins" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.Description, children: "Resets the player and dealer win count back to zero" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.ControlWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles.Control, onClick: () => gameStats.reset(), children: "Clear" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.GameSetting, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.Info, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.Header, children: "Audio Enabled" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.Description, children: "Whether or not sound effects should play" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.ControlWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          CheckBox,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.GameSetting, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.Info, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.Header, children: "Hit Warnings Enabled" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.Description, children: 'Whether or not you want to see a warning if you click "hit" while already having a reasonably high score' })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.ControlWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          CheckBox,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.GameSetting, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.Info, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.Header, children: "Stick Warnings Enabled" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.Description, children: 'Whether or not you want to see a warning if you click "stick" while having a fairly low score' })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.ControlWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          CheckBox,
          {
            ...
            onChanged: () => gameSettings.toggleWarningEnabled("stick-on-low")
          }
        ) })
      ] })
    ] })
...
const App = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "App", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "Content", children: [
    settingsModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(GameSettings, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Table, { hide: settingsModalOpen })
  ] }) });
};
