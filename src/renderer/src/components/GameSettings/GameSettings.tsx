      ...
      <div className={styles.Content}>
        <div className={styles.GameSetting}>
          ...
          <div className={styles.ControlWrapper}>
            <button className={styles.Control} onClick={() => gameStats.reset()}>
              Clear
            </button>
          </div>
        </div>
        ...
        <div className={styles.GameSetting}>
          <div className={styles.Info}>
            ...
            <span className={styles.Description}>Whether or not sound effects should play</span>
          </div>
          <div className={styles.ControlWrapper}>
            <CheckBox
        ...
        <div className={styles.GameSetting}>
          <div className={styles.Info}>
            ...
            <span className={styles.Description}>
              Whether or not you want to see a warning if you click &quot;hit&quot; while already
              having a reasonably high score
            </span>
          </div>
          <div className={styles.ControlWrapper}>
            <CheckBox
        ...
        <div className={styles.GameSetting}>
          <div className={styles.Info}>
            ...
            <span className={styles.Description}>
              Whether or not you want to see a warning if you click &quot;stick&quot; while having a
              fairly low score
            </span>
          </div>
          <div className={styles.ControlWrapper}>
