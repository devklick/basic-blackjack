...
export interface UseCardPileReturn {
  cards: CardObject[];
  hand: BestHand;
  bust: boolean;
  allCardsVisible: boolean;
  fiveCardTrick: boolean;
  addCards: (cardsToAdd: CardObject[], facing?: Facing | null) => void;
  setCards: (cardsToSet: CardObject[]) => void;
  setCardsFacing: (facing: Facing) => void;
}
 ...
 */
export function useCardPile(): UseCardPileReturn {
   ...
   */
  function addCards(cardsToAdd: CardObject[], facing: Facing | null = null): void {
   ...
   */
  function setCards(cardsToSet: CardObject[]): void {
    let allVisible = true;
   ...
   */
  function setCardsFacing(facing: Facing): void {
    setCards(
      [...cards].map((c) => {
        c.facing = facing;
        return c;
