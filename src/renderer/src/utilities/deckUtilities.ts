import { CardObject, CardRankMetadataMap, CardRanks, CardSuits } from '../components/Card';
...
const getHighestCardValue = (cards: CardValue[]): CardValue => {
...
const getScoreWinner = (playerScore: number, dealerScore: number): GameResult | null => {
...
interface GetCardCountWinnerReturn {
  winner: Participant;
  winnerText: string;
}
